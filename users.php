...
<body id="bs-override">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- pengaduan -->
            <li class="nav-item">
                <a class="nav-link" href="?url=add_pengaduan">
                    <i class="fas fa-fw fa-edit"></i>
                    <span>Tulis Pengaduan</span></a>
            </li>
            <!-- lihat laporan -->
            <li class="nav-item">
                <a class="nav-link" href="?url=view_pengaduan">
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar-->
                    <h4 class="resp-logo my-auto bg-primary text-white p-2 rounded shadow"> <b>e-Pelaporan dan
                            e-Pengaduan
                            Masyarakat</b>
                    </h4>
