...
if ($_SESSION['level']!= "petugas") {
    die('Login Sebagai Petugas Untuk Melanjutkan');
};
...
<head>
    ...
    <title>Halaman Petugas | e-PPeM</title>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <!-- Topbar-->
                    <p class="nav-text bg-primary text-white p-2 rounded shadow"> <b>e-Pelaporan dan e-Pengaduan
                            Masyarakat</b>
                    </p>
